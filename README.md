...
| `sleuth replay <id>` | Re-run a saved journey deterministically |
...
| App startup detection | Planned |
| Scanner (React) | ✓ Done |
| Browser runner + evidence store | Planned |
| Guided mode + session handling | Planned |
| Deterministic audits (axe, console, network) | Planned |
| LLM engine + findings schema validation | Planned |
| Reporting | Planned |
| Replay command | Planned |
